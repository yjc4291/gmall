...
public class OssController {
    ...
    String accessId = "LTAI4GCoME4MEfx9EceJaWAu"; // 请填写您的AccessKeyId。
    String accessKey = "RZKDqp4yie9XNWcaMnskIQvjy9QYsS"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "guli-file-200316"; // 请填写您的 bucketname 。

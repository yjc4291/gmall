...
public class UserAddressController {
    ...
    public ResponseVo<List<UserAddressEntity>> queryAddressesByUserId(@PathVariable("userId")Long userId){
        List<UserAddressEntity> userAddresses = this.userAddressService.list(new QueryWrapper<UserAddressEntity>().eq("user_id", userId));
        return ResponseVo.ok(userAddresses);
    }

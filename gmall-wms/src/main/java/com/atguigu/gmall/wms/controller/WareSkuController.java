...
public class WareSkuController {
    ...
    public ResponseVo<List<SkuLockVo>> checkAndLockStock(@RequestBody List<SkuLockVo> lockVos,
                                                         @PathVariable("orderToken") String orderToken){
        List<SkuLockVo> skuLockVos = this.wareSkuService.checkAndLockStock(lockVos, orderToken);
